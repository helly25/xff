...
- **`xff --html`**: Renders the same complete reference as a standalone, self-contained HTML5 document with no scripts or external assets. Release Pages publish this form for direct browsing.
