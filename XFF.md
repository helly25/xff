...
- `-fuzzypath ARG` - match the whole path loosely: PATTERN's characters in order, gaps allowed (xff) _(test, xff)_
...
- `-ifuzzypath ARG` - match the whole path loosely, case-insensitively (xff) _(test, xff)_
